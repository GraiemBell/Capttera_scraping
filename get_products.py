...
# errolistname = []
# with open("errolistname.txt", "r") as f:
#     errolistname = f.read().split("\n")

# errolisturl = []
# with open("errorlisturl.txt", "r") as f:
#     errolisturl = f.read().split("\n")

# for id, el in enumerate(errolisturl):
#     print(el)
#     product_data = get_product_data(el)
#     with open(f"pull/{product_data['name']}.json", "w") as f:
#         json.dump(product_data, f)